...
export function PrepositionChoicePage() {
  const {
    view,
    profile,
    selections,
  ...
  if (error) {
    return (
      <div className="mx-auto max-w-2xl">
        <h1 className="mb-4 text-2xl font-semibold text-slate-800">Similar Prepositions</h1>
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <h1 className="mb-2 text-2xl font-semibold text-slate-800">Similar Prepositions</h1>
      <p className="mb-6 text-sm text-slate-600">
        Fill in the blank with the correct preposition when two words are easily confused (for
        example <em>in</em> vs <em>into</em>).
      </p>
